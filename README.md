...
Pinecone Agentic RAG | Example demonstrating how to use Chonkie's PineconeHandshake in an agentic RAG pipeline | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1GtnmSZcPNmT3-MfaOKJ24_HjAg72KODf?usp=sharing) |
| LlamaIndex + Chonkie: Document Q&A with Recursive Chunking | Learn how to use Chonkie as a native LlamaIndex node parser. Build a simple RAG over a Wikipedia article using Chonkie's Recursive Chunker | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/chonkie-inc/chonkie/blob/main/cookbook/tutorials/chonkieXllamaindex.ipynb) |
